  ...
  public static void openPanel(Player player, String arenaname) {
    ...
    if (arena != null) {
      ...
      arenaNameNote_IM.setDisplayName(
          MessageM.replaceAll("%NSettings of arena: %A" + arena.arenaName));
      ...
      disguiseBlocks_NOTE_IM.setDisplayName(
          MessageM.replaceAll("%NSet the %AdisguiseBlocks%N."));
