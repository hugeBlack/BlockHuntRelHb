...
public class Arena implements ConfigurationSerializable {
  ...
  public Arena(String arenaName, LocationSerializable pos1, LocationSerializable pos2, int maxPlayers, int minPlayers, int amountSeekersOnStart, int timeInLobbyUntilStart, int waitingTimeSeeker, int gameTime, int timeUntilHidersSword, ArrayList<ItemStack> disguiseBlocks, LocationSerializable lobbyWarp, LocationSerializable hidersWarp, LocationSerializable seekersWarp, LocationSerializable spawnWarp, List<String> seekersWinCommands, List<String> hidersWinCommands, List<String> allowedCommands, int seekersTokenWin, int hidersTokenWin, int killTokens, List<Player> playersInArena, ArenaState gameState, int timer, List<Player> seekers, Scoreboard scoreboard) {
  ...
  public static Arena deserialize(Map<String, Object> map) {
    ...
    return new Arena((String)M.g(map, "arenaName", "UNKNOWN_NAME"), 
        ...
        (ArrayList)M.g(map, "seekersWinCommands", 
          new ArrayList()), (ArrayList)M.g(map, 
          "hidersWinCommands", new ArrayList()), 
        (ArrayList)M.g(map, "allowedCommands", 
          new ArrayList()), (Integer) M.g(map,
            "seekersTokenWin", 10), (Integer) M.g(map,
            "hidersTokenWin", 50), (Integer) M.g(map, "killTokens",
            8), new ArrayList<>(), ArenaState.WAITING, 0,
        new ArrayList<>(), Bukkit.getScoreboardManager()
        .getNewScoreboard());
  }
}