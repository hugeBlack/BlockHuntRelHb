...
public enum ConfigC {
  chat_tag(
    ...
    "[" + BlockHunt.pdfFile.getName() + "] ", W.config),
  ...
  commandEnabled_info(Boolean.valueOf(true), W.config),
  commandEnabled_help(Boolean.valueOf(true), W.config),
  commandEnabled_reload(Boolean.valueOf(true), W.config),
  ...
  blockChooserPrice(Integer.valueOf(3000), W.config),
  seekerHiderPrice(Integer.valueOf(150), W.config),
  wandEnabled(Boolean.valueOf(false), W.config),
  ...
  sign_WAITING(new String[] { "%H[" + BlockHunt.pdfFile.getName() + "%H]", 
      "%A%arenaname%", "%A%players%%N/%A%maxplayers%", "&8Waiting..." }, W.config),
  ...
  log_enabledPlugin("%TAG%N%name%&a&k + %version% is now Enabled.",
    W.messages),
  log_disabledPlugin("%TAG%N%name%&c&k - %version% is now Disabled.",
    W.messages),
